...
export class Ludo{
    ...
    setPiecePosition(player, piece, newPositon) {
        this.currentPositions[player][piece] = newPositon;
      UI.setPiecePosition(player, piece, newPositon)
    }
    ...
    checkForKill(player, piece) {
      ...
      [0, 1, 2, 3].forEach(piece =>{
        ...
        if(currentPosition === opponentPosition && !SAFE_POSITIONS.includes
            (currentPosition)) {
             this.setPiecePosition(opponent, piece, BASE_POSITIONS[opponent]
                [piece]);
                kill = true
        }
      });
    ...
    hasPlayerWon(player) {
       return [0, 1, 2, 3].every(piece => this.currentPositions[player][piece] === HOME_POSITIONS[player][piece])
    }
